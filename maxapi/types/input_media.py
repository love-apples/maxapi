...
class InputMedia:
    ...
    Ограничения: сервер MAX ограничивает файлы по типу
    (см. https://dev.max.ru/docs-api/methods/POST/uploads) —
    image до 50 МБ и ≤7680×7680 px, video до 250 МБ, audio до
    256 МБ и ≤60 мин, file до 4 ГБ. Библиотека при загрузке
    только предупреждает в логе о превышении размера.
